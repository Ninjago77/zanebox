...
class NRF24L01:
    def __init__(self, spi, cs, ce, channel=46, payload_size=16):
        ...
        # Try changing the data rate to 1MBPS for better compatibility with clones
        self.set_power_speed(POWER_3, SPEED_1M)
        
        # POWER_0 is the lowest power setting (-18dBm)
        # This reduces the current spikes that crash the module
        # self.set_power_speed(POWER_0, SPEED_1M)
